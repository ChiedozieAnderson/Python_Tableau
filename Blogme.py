# -*- coding: utf-8 -*-
"""
Created on Tue Feb 21 20:20:21 2023
...
#format of groupby: df.groupby(['col_to_group'])['col_tocount].count()

data.groupby(['source_id'])['article_id'].count()

#group by reaction of publisher
...
a = aboutMe('Anderson', 'Okolo', 'Nigeria')
